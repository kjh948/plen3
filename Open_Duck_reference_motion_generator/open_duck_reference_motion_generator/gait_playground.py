...
parser.add_argument(
    "--duck",
    choices=["go_bdx", "open_duck_mini", "open_duck_mini_v2", "plen2"],
    help="Duck type",
    required=True,
)
...
class GaitParameters:
    def __init__(self):
        ...
        elif args.duck == "plen2":
            self.robot = 'plen2'
            self.robot_urdf = "plen.urdf"
            self.asset_path = os.path.join(script_path, "../open_duck_reference_motion_generator/robots/plen2/")
...
def change_robot():
    ...
    if selected_robot in ['go_bdx', 'open_duck_mini', 'plen2']:
