...
public:
  ...
  */
  ...
  /*
          @brief Add differences between current-frame and next-frame to
     current-frame
  */
  void updateFrame();
  ...
  */
  ...
  /*!
          ...
          however, property "device"'s type is not string but integer defined as
     device id in "device_map.json".
